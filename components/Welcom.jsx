      ...
      <div className={s.content}>
        ...
        <div className={s.welcom_wrapper}>
          <article className={`${s.text}`}>
            <p>
              Наша современная стоматологическая клиника в Витебске, способна гарантировать
              быстрое, безболезненное и качественное лечение зубов. Это касается даже
              ...
              потребности пациента, но и его бюджет.
            </p>
            <p>
              Мы понимаем, что время пациента ценно, поэтому в нашей клинике
              время приёма не имеет чётких рамок. Мы стремимся сделать все
              работы качественно и полностью посвящаем каждому этапу лечения
              достаточно внимания. Но наша забота о пациентах не ограничивается
              только медицинскими аспектами. Мы также стремимся создать
              комфортную и приятную атмосферу в нашей клинике. Наши дружелюбные
              и внимательные сотрудники всегда готовы ответить на ваши вопросы и
              обеспечить вас заботливым отношением.
            </p>
            <p>
